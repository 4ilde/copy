                ...
                <div class="container">
                    ...
                    <div style="padding: 50px 0;margin-top: 50px;background-color: #fff; text-align: right;width: 420px;margin: 50px auto;">
                        <form id="form1" class="form-horizontal" action="checkInServlet" method="post">
                            ...
                            <div class="form-group">
                                <label for="duration" class="col-xs-3 control-label">身份证号：</label>
                                <div class="col-xs-6">
                                    <input type="" name="client_idno" class="form-control input-sm duiqi" id="clientIdNo" placeholder="请输入身份证号！">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="duration" class="col-xs-3 control-label">手机号：</label>
                                <div class="col-xs-6">
                    ...
                    <div style="padding: 50px 0;margin-top: 50px;background-color: #fff; text-align: right;width: 420px;margin: 50px auto;">
                        <form id="form4" class="form-horizontal" action="employeeReserveServlet" method="post">
                            <div class="form-group ">
                                <label for="clientNo" class="col-xs-3 control-label" >用户名：</label>
                                <div class="col-xs-6 ">
                                    <input type="" name="clientNo" class="form-control input-sm duiqi" id="clientNo2" placeholder="请输入客户ID！">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="duration" class="col-xs-3 control-label">手机号：</label>
                                <div class="col-xs-6">
                                    <input type="" name="phone_no" class="form-control input-sm duiqi" id="phone_no2" placeholder="请输入手机号！">
                                </div>
                            </div>
                            <div class="form-group ">
